            ...
            <ul id="about-list">
                <li className="about-li">
                    ...
                    <div className="about-logos">
                        <img className="user-object--avi" src="https://avatars.githubusercontent.com/u/76574880?v=4" />
                ...
                <li className="about-li">
                    <p>Nick</p>
                    <div className="about-logos">
                        <img className="user-object--avi" src="https://avatars.githubusercontent.com/u/75050631?v=4" />
                ...
                <li className="about-li">
                    <p>Sarah</p>
                    <div className="about-logos">
                        <img className="user-object--avi" src="https://avatars.githubusercontent.com/u/75630072?v=4" />
                ...
                <li className="about-li">
                    <p>Nate</p>
                    <div className="about-logos">
                        <img className="user-object--avi" src="https://avatars.githubusercontent.com/u/24424412?v=4" />
